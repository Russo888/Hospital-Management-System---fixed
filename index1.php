            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password2" placeholder="enter password" autocomplete="current-password" required/></div><br><br><br>
                </div>
                <div class="row">
