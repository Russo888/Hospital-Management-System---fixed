...
6. In phpmyadmin page, create a new database from the left panel and name it as 'myhmsdb_final'
7. Import the file 'myhmsdb.sql' inside your newly created database and click ok. (Note: The SQL file is named myhmsdb.sql but you can import it into myhmsdb_final)
