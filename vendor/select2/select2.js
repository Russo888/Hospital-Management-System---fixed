(function () {
  if (window.define) { var define = window.define; } if (window.require) { var require = window.require; } if (window.jQuery && jQuery.fn && jQuery.fn.select2 && jQuery.fn.select2.amd) { var define = jQuery.fn.select2.amd.define; var require = jQuery.fn.select2.amd.require; }/**
  ...
  define('select2/utils', [
    ...
    Utils.generateChars = function (length) {
      ...
      for (var i = 0; i < length; i++) {
        ...
        var randomChar = cryptoArray[0] % 36;
